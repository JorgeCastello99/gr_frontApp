...
import { MenuTComponent } from './components/menu-t/menu-t.component';
...
const routes: Routes = [
  ...
  { path: "platform", component: UserhandlerComponent,  canActivate: [AuthGuardService], children: [
    ...
    //Profesores
      { path: "teacher", component: MenuTComponent, canActivate: [AuthGuardService], children: [
        {path: "clases", component: ClasesComponent, canActivate: [AuthGuardService]},
        {path: "vcoach", component: VcoachComponent, canActivate: [AuthGuardService]}
      ]},
    //school-admin
      { path: "school-admin", component: MenuAComponent, canActivate: [AuthGuardService], children: [
        {path: "gestion", component: TeachersComponent, canActivate: [AuthGuardService]}
      ]},
